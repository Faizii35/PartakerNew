...
class DonorAdapter(val context: Context, private val donationItemClickListener: MyDonationsClickListener):RecyclerView.Adapter<DonorAdapter.DonorViewHolder>()
{
